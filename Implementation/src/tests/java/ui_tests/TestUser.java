...
public class TestUser {
  ...
  public static User getTestUser() {
    ...
    Transaction trans2 = TransactionCreator.newTransaction("DIVIDEND", 30240.00f, "test2",user.getCategoryStore());
    Transaction trans3 = TransactionCreator.newTransaction("SALARY", 200.00f, "test3",user.getCategoryStore());
    Transaction trans4 = TransactionCreator.newTransaction("DIVIDEND", 10.00f, "test4",user.getCategoryStore());
    Transaction trans5 = TransactionCreator.newTransaction("FOOD", 340.00f, "food1",user.getCategoryStore());
    Transaction trans6 = TransactionCreator.newTransaction("FOOD", 20.00f, "food2",user.getCategoryStore());
    Transaction trans7 = TransactionCreator.newTransaction("FOOD", 930.00f, "food3",user.getCategoryStore());
    Transaction trans8 = TransactionCreator.newTransaction("FOOD", 10.00f, "food4",user.getCategoryStore());
