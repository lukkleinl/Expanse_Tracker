...
public class AddDepositPage extends AbstractPage {
   ...
   * 
   * @param user the user whowants to add a new deposit
   */
  // In Final Version might take a User object to display additional User information.
  public AddDepositPage(final User user) {
    this.user = user;
  ...
  protected void createComponents() {
    ...
    this.depositCategorys = this.user.getCategories(new DepositCategory()).toArray();
    ...
    this.categoryInputText = new JLabel("Deposit Category:");
    ...
    this.categoryInputBox = new JComboBox(this.depositCategorys);
    ...
    this.deleteCategoryButton.addActionListener(
        actionEvent -> {
          ...
          if (delete == JOptionPane.YES_OPTION) {
            if (box.getSelectedItem().toString().equals("DIVIDEND")
                || box.getSelectedItem().toString().equals("SALARY")) {
    ...
    this.newCategoryOptionPaneButton.addActionListener(actionEvent -> {
      ...
      if (categoryName != null) {
        this.user.newTransactionCategory(new DepositCategory(categoryName));
        this.depositCategorys = this.user.getCategories(new DepositCategory()).toArray();
        this.refreshWanted = true;
      }
  ...
  protected void resetTitle(final JFrame frame) {
    frame.setTitle("Add/Change Deposit - Page");
  }
   ...
   */
  public void updateFields(final Deposit transaction) {
